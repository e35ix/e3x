...
import { useNotificationService } from "@/components/notification-service-provider"

// Define a mock notification service for SSR
const mockNotificationService = {
  initialize: async () => { console.log("Mock notification service initialized during SSR."); },
...
export default function LoginPage() {
  ...
  // Conditionally get the notification service on the client side
  const notificationService = typeof window !== 'undefined' ? useNotificationService() : mockNotificationService;
  ...
  const handleLogin = async (provider: string) => {
    ...
    try {
      ...
      // Ensure notificationService is available and not the mock during client-side interaction
      if (notificationService && notificationService !== mockNotificationService) {
        await notificationService.initialize()
      } else {
        console.warn("Notification service not fully loaded or mocked during handleLogin.");
      }
